...
//     if (menh == 'kim') {
//       if (item == 'lộc') {
//         randomNumber = Math.random() < 0.5 ? 1 : 6;
//       } else if (item == 'bạn') {
//         randomNumber = Math.random() < 0.5 ? 4 : 9;
//       } else if (item == 'vượng') {
//         randomNumber = 5; // Chỉ có một giá trị cho 'vượng'
//       }
//     } else if (menh == 'mộc') {
//       if (item == 'lộc') {
//         randomNumber = Math.random() < 0.5 ? 2 : 7;
//       } else if (item == 'bạn') {
//         randomNumber = Math.random() < 0.5 ? 3 : 8;
//       } else if (item == 'vượng') {
//         randomNumber = Math.random() < 0.5 ? 1 : 6;
//       }
//     } else if (menh == 'thủy') {
...
//     } else if (menh == 'hỏa') {
//       if (item == 'lộc') {
//         randomNumber = 5; // Chỉ có một giá trị cho 'lộc'
//       } else if (item == 'bạn') {
//         randomNumber = Math.random() < 0.5 ? 2 : 7;
//       } else if (item == 'vượng') {
//         randomNumber = Math.random() < 0.5 ? 3 : 8;
...
//         randomNumber = Math.random() < 0.5 ? 4 : 9;
//       } else if (item == 'bạn') {
//         randomNumber = 5; // Chỉ có một giá trị cho 'bạn'
//       } else if (item == 'vượng') {
//         randomNumber = Math.random() < 0.5 ? 2 : 7;
//       }
//     }
...
// Kiểm tra hàm với dữ liệu đầu vào cụ thể
console.log("kết quả trả về : "+randomNumbers(['lộc', 'lộc', 'lộc', 'lộc', 'vượng', 'bạn'], 'kim'));

  
 
//   console.log("Đây là kết quả"+ randomNumbers(['lộc','lộc','lộc','lộc','vượng','bạn'], 'kim'));
  ...
  var data = [
    ...
    },
    {
        ...
        id: 31,
         ...
         td2: 'lộc - bạn',
         td3: 'bạn - lộc',
         array:['vượng','bạn','lộc','bạn','bạn','lộc']
    },{
        id: 32,
         td1: 'bạn - bạn',
         td2: 'lộc- bạn',
    ...
    },
    {
        ...
        },
        {
            ...
            "td2": "vượng vượng",
            "td3": "lộc bạn",
            "array": ["vượng", "vượng", "vượng", "vượng","lộc", "bạn"]
        },
        {
            "id": 81,
            "td1": "vượng vượng",
            "td2": "vượng vượng",
            "td3": "bạn lộc",
            "array": ["vượng", "vượng", "vượng", "vượng","bạn", "lộc"]
        },
        {
            "id": 82,
            "td1": "Vượng bạn",
        ...
        },
        {
            ...
            "td2": "bạn vượng",
            "td3": "lộc bạn",
            "array": ["bạn", "vượng", "bạn", "vượng", "lộc", "bạn"]
        },
        {
            "id": 84,
            "td1": "bạn vượng",
            "td2": "bạn vượng",
            "td3": "bạn lộc",
            "array": ["bạn", "vượng", "bạn", "vượng","bạn",  "lộc"]
        },
        {
            "id": 85,
            "td1": "vượng vượng",
            "td2": "vượng vượng",
            "td3": "lộc lộc",
            "array": ["vượng", "vượng","vượng", "vượng", "lộc", "lộc"]
        },
        {
            "id": 86,
            "td1": "Vượng bạn",
        ...
        },
        {
            ...
            "td2": "bạn vượng",
            "td3": "lộc lộc",
            "array": ["bạn", "vượng", "bạn", "vượng", "lộc", "lộc"]
        },
        {
            "id": 88,
            "td1": "bạn vượng",
        ...
        },
        {
            ...
            "td2": "bạn vượng",
            "td3": "lộc lộc",
            "array": ["vượng", "vượng", "bạn", "vượng", "lộc","lộc"]
        },
        {
            "id": 90,
            "td1": "Vượng bạn",
            "td2": "bạn vượng",
            "td3": "lộc lộc",
            "array": ["Vượng", "bạn", "bạn", "vượng", "lộc","lộc"]
        },
        {
            "id": 91,
            "td1": "bạn vượng",
            "td2": "Vượng bạn",
            "td3": "lộc lộc",
            "array": ["bạn", "vượng", "vượng", "bạn", "lộc","lộc"]
        },
        {
            "id": 92,
            "td1": "bạn vượng",
  ...
  var tableBody = document.getElementById("customers");
        ...
        document.getElementById("searchButton").addEventListener("click", function() {
            ...
            const menh = menhip.textContent.trim();
            console.log("Đây là mệnh " + menh);
            const arr = ip.split(',');
            ...
            do {
                ...
                const resultNumber = parseInt(numberString, 10);
                ...
                if (attempts >= maxAttempts) {
                    console.error("Không tìm thấy số đẹp sau số lần thử tối đa");
                    break;
                }
            ...
            if (attempts < maxAttempts) {
                ...
                console.log("Không tìm thấy số đẹp sau số lần thử tối đa");
            }
        });
